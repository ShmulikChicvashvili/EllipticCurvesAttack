...
int partition_function(ECCpoint P) {
	return (rep(P.a) % NUM_BRANCHES);
}
...
int main() {
   ...
   ZZ_p::init(p);
	...
	cout << E.pollard_attack(P, Q, p) << endl;
	system("pause");
	return 0;
}